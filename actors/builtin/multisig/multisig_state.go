...
func getPendingTransaction(ptx *adt.Map, txnID TxnID, cid cid.Cid) (Transaction, error) {
	var out Transaction
	...
	if !found {
		return Transaction{}, errors.Errorf("failed to find transaction %v in HAMT %s", txnID, cid)
	}
