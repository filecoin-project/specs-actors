...
func TestFullPathSuccess(t *testing.T) {
	...
	v = vm.AdvanceOneEpoch(t, v)
	require.True(t, vm.CheckSectorHealth(t, v, minerAddrs.IDAddress, deadlineIndex, partitionIndex, sectorNumber))
	...
	require.False(t, vm.CheckSectorHealth(t, v, minerAddrs.IDAddress, deadlineIndex, partitionIndex, sectorNumber))
...
func createSector(t *testing.T, v *vm.VM, workerAddress address.Address, minerAddress address.Address, sealProof abi.RegisteredSealProof) (*vm.VM, uint64, uint64, abi.SectorNumber) {
